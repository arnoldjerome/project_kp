                ...
                <div class="mb-4">
                    @auth
                        ...
                        @elseif(Auth::user()->role === 'admin')
                            <button class="btn btn-warning w-100" data-bs-toggle="modal" data-bs-target="#editProductModal">Edit
                                Product</button>
                            <button type="button" id="deleteProductBtn" class="btn btn-danger w-100 mt-2">Delete
                                Product</button>
                        @endif
                    @else
                ...
                <div class="accordion" id="productDetailsAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header"><button class="accordion-button collapsed"
                                data-bs-toggle="collapse" data-bs-target="#collapseDesc">Description</button></h2>
                    ...
                    if (confirm("Apakah Anda yakin ingin menghapus produk ini?")) {
                        fetch("{{ route('products.destroy', $product->id) }}", {
                            ...
                            .then(data => {
                                ...
                                window.location.href = "{{ url('/productint') }}"; // redirect ke halaman produk indoor
                            })
                            .catch(error => {
                                console.error(error);
