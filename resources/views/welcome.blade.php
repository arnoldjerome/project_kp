...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"
        integrity="sha512-wNfYc2rO2mfIyt9f9Q4tZ0O0ax9OdrN+jC8A1y6v9Ek5CRmRUJzjXigIQdcZkXzHZQzLxxBvlh9PvWRZ6HFvYw=="
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    ...
                    <p class="mb-4">Crafted from premium teak wood, this indoor product combines natural beauty with
                        exceptional durability. Designed for indoor use, it showcases the timeless appeal of solid
                        teak—renowned for its strength, sturdiness, and resistance to wear. With a finely finished
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    ...
                    <p class="mb-4">Expertly crafted from solid teak wood, this outdoor piece is made to withstand the
                        elements. Designed for open-air environments, it boasts exceptional strength, weather
                        resistance, and timeless charm. The natural durability of teak ensures that it remains sturdy
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5 ps-lg-5">
                    ...
                    <p style="color: white;">We offer custom furniture and wood products tailored to your unique ideas
                        and needs. Simply click the chat button to connect with our customer service team and share your
                        concept. If you already have a sketch, feel free to send it over. Don’t have one yet? No
                        worries—our team can help create a sketch for you.</p>
                    <br>
                    <p style="color: white;"><b>Tap the chat button now and let’s start bringing your dream wood
                            creation to life!</b></p>
    ...
    <footer class="footer-section">
        <div class="container relative">
            ...
            <div id="footer" class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">Bali Cipta
                            Sarana<span>.</span></a></div>
                    <p class="mb-4">Bringing timeless comfort and style to both indoor and outdoor living.</p>
